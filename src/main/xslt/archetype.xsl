...
<xsl:text>
	...
	<artifactId>powerunit-extensions-matchers-archetype</artifactId><xsl:text>
</xsl:text>
					</xsl:when>
					<xsl:when test="name()='name'">
<xsl:text>
	</xsl:text>
	<name><xsl:copy-of select="text()" /> - Archetype</name><xsl:text>
</xsl:text>
					</xsl:when>
					<xsl:when test="name()='description'">
<xsl:text>
	</xsl:text>
	<description><xsl:copy-of select="text()" /> - Archetype</description><xsl:text>
</xsl:text>
					</xsl:when>

...
<xsl:text>
	...
	<artifactId>powerunit-extensions-matchers-providematchers</artifactId><xsl:text>
</xsl:text>
					</xsl:when>
					<xsl:when test="name()='name'">
<xsl:text>
	</xsl:text>
	<name><xsl:copy-of select="text()" /> - ProvideMatchers Support</name><xsl:text>
</xsl:text>
					</xsl:when>
					<xsl:when test="name()='description'">
<xsl:text>
	</xsl:text>
	<description><xsl:copy-of select="text()" /> - ProvideMatchers Support</description><xsl:text>
</xsl:text>
					</xsl:when>

 ...
 * <p>
 * Let's assume you have a field annotated in the following way (included in a
 * class named {@code PojoWithOverrideField}) :
 * 
 * <pre>
 ...
 * </pre>
 * 
 * Then additional DSL method will be added :
 * 
 * <pre>
 * &#64;Override
 * public PojoWithOverrideFieldMatcher&gt;_PARENT&lt; fieldSuffix() {
 * 	// Does nothing, just for sample
 * 	return this;
 * }
 * 
 * &#64;Override
 * public PojoWithOverrideFieldMatcher&gt;_PARENT&lt; fieldSuffixTest(java.lang.String test) {
 * 	// Does nothing, just for sample
 * 	return this;
 * }
 * </pre>
...
public @interface AddToMatcher {
	 ...
	 * <p>
	 * The name used inside the DSL will be composed of the fieldName (starting with
	 * a lower case), followed by the value of this suffix. Use an empty String when
	 ...
	 * <p>
	 * This method must not return anything ; A {@code return this;} will be added
	 * by the framework at the end.
	 * 
	 * @return the body.
	 */
	String[] body();
